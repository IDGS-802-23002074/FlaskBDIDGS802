...
inscripcion = db.Table('inscripcion',
    db.Column('alumno_id', db.Integer, db.ForeignKey('alumno.id')),
...
class Maestro(db.Model):
    ...
    cursos = db.relationship('Curso', backref='maestro', lazy=True)
...
class Curso(db.Model):
    ...
    maestro_id = db.Column(db.Integer, db.ForeignKey('maestro.id'))

    alumnos = db.relationship('Alumno', secondary=inscripcion, back_populates="cursos")
    """
